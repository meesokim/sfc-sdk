...
iproc internal_init
	...
	;lda #$01	; Yoshi addition, although A should already contain this.
	...
	;stz 	$4200   ; Enable V-blank, interrupt, Joypad register ; You mean disable.
	lda #%10110001
	sta $4200
